            ...
            <div className="flex flex-col md:flex-row w-full space-y-3 md:divide-x-2 px-10 md:space-y-0 max-w-full">
              <div className="flex justify-center flex-col md:flex-row">
                ...
                <div className="flex flex-col space-y-3">
                  <h3 className="text-2xl md:text-4xl font-bold leading-8 text-white">
                    Contact Us
                  </h3>
                  <div>
                    ...
                    <p className="text-white  py-2 text-sm leading-tight">
                    ...
                    <p className="text-white  py-2 text-sm leading-tight"></p>
                    <p className="text-white  py-2 text-sm leading-tight"></p>
                    <h2 className="text-lg md:text-2xl font-semibold text-white">
                      Affiliate Program
                    </h2>
                ...
                <div className="flex flex-col space-y-1 md:space-y-2">
                  <h2 className="text-lg md:text-3xl tracking-tight font-semibold text-white">
                    Send us a Message
                  </h2>
                </div>
