...
const options = ["Relevance", "Most Popular", "Top Ranked", "Top Rated", "Newest", "Release Date", "Recently Added"];
const sorts = [
    {
      name: "Relevance",
      slug: "Relevance",
...
const SortGeneral = () => {
  ...
  return (
    ...
    <div className="relative flex items-center justify-between px-2 border border-[#0c9bff] bg-transparent text-white rounded-full w-40 h-8 cursor-pointer" ref={autoRef} onClick={toggling}>
