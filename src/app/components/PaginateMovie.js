...
const PaginateMovie = () => {
  return (
    <>
      <div className="flex items-center justify-center mt-0 pb-10 space-x-1.5">
        <button
          disabled=""
          className=" rounded-full p-2 text-[#404040] disabled:text-[#A3A3A3] cursor-not-allowed disabled:cursor-not-allowed"
        ...
        <Link
          className="rounded-full p-1 w-8 h-8 text-center text-sm font-medium flex justify-center items-center text-black bg-[#00dc89] border border-gray-900"
          href="/blog?category=All%20Categories&amp;page=1"
        >
          1
        </Link>
        <Link
          className="rounded-full p-1 w-8 h-8 text-center text-sm font-medium flex justify-center items-center text-white "
          href="/blog?category=All%20Categories&amp;page=2"
        >
          2
        </Link>
        <Link
          className="rounded p-1 w-8 h-8 text-center text-sm font-medium flex justify-center items-center text-white "
        ...
        <button
          className=" rounded-full p-1.5 text-white  hover:text-black hover:bg-[#00dc89] disabled:text-[#A3A3A3] disabled:cursor-not-allowed"
