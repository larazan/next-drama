  ...
  return (
    <>
     <div className="flex  z-30">
      <div className="relative flex items-center justify-between px-2 border border-[#0c9bff] bg-transparent text-white rounded-full w-20 h-8 cursor-pointer" ref={autoRef} onClick={toggling}>
          ...
          {isOpen && (
            <div className="min-w-[70px] absolute top-5 py-2 right-0 z-10 mt-4 origin-top-right rounded border border-gray-200 bg-white shadow-lg  overflow-y-auto">
