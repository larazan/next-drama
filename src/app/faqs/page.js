            ...
            <div className="flex w-full flex-1 flex-col items-center justify-center relative">
              <div className="flex w-full flex-1 flex-col pb-18 max-w-md md:max-w-2xl ">
                <section className="w-full mx-auto mt-6 md:mt-6 px-5 ">
                  <h5 className="font-semibold md:font-bold text-2xl md:text-3xl text-center text-white">
                    Frequently asked questions
                  </h5>
                  <p className="mt-3 font-normal text-md md:text-lg text-white text-center ">
                    Browse through the most frequently asked questions.
                  </p>
                  <dl className="w-full mt-6 space-y-2 md:space-y-6 divide-y divide-white">
