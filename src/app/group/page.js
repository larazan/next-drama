...
import bornpink from "@/assets/album/bornpink.jpg"
import album from "@/assets/album/album.jpg"
import Kill_This_Love from "@/assets/album/Kill_This_Love.png"

import bp from "@/assets/actress/bp.png"
import blackpink from "@/assets/actress/Blackpink.jpg"
      ...
      <div className="relative md:relative w-full flex flex-col justify-center md:h-[480px] mx-auto h-[420px] xs:items-end xs:justify-end md:items-start md:justify-center text-white ">
        ...
        <div className="absolute w-full h-full">
          <div className="w-full h-full">
            ...
            >
              <Image src={blackpink} alt="" className="object-cover h-full w-full" />
            </div>
          </div>
        </div>
              ...
              <div className="flex-col py-2 md:py-4 text-white">
                ...
                <div className="flex-col space-y-2 md:space-y-3 pt-2 md:pt-4">
                  <div className="flex-col">
                    ...
                    <div>
                      <span className="text-sm">2016 - recent</span>
                    </div>
                  </div>
                  <div className="flex-col">
                    <div>
                      <span className="font-semibold">Formed</span>
                    </div>
                    <div>
                      <span className="text-sm">2015 in seoul</span>
                    </div>
                  </div>
                  <div className="flex-col">
                    <div>
                    ...
                    <div>
                      <span className="text-sm">Pop/Rock</span>
                    </div>
                  </div>
                  ...
                  <div className="flex-col">
                    ...
                    <div>
                      <span className="text-sm">Black Pink</span>
                    </div>
                  </div>
                  <div className="flex-col">
                    <div>
                    ...
                    <div className='flex flex-col'>
                      <ul>
                        <li>
                        <span className="text-sm capitalize">jisoo</span>
                        </li>
                        <li>
                        <span className="text-sm capitalize">jennie</span>
                        </li>
                        <li>
                        <span className="text-sm capitalize">rose</span>
                        </li>
                        <li>
                        <span className="text-sm capitalize">lisa</span>
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            <div className="w-full md:w-2/3 md:pl-3">
              <div className="text-white">
                <div className="hidden md:flex justify-between">
                  <span className="text-3xl font-bold">Blackpink</span>
                    ...
                    <div className="inline-flex space-x-3">
                      {albumData.map((role, id) => (
                        ...
                        >
                          ...
                          <div className="flex flex-col text-center text-sm capitalize">
